    ...
    <div className="min-h-screen bg-black px-4 py-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-6">
          ...
          <div className="w-full h-1 bg-accent mb-4"></div>
          ...
          {/* Instructions */}
          <div className="space-y-5 mb-6 text-left max-w-2xl mx-auto">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-accent flex items-center justify-center text-black font-bold">
                1
              </div>
              <div>
                <h2 className="text-lg font-semibold mb-1">Input your old bitmask username or nPUB key</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-semibold mb-1">Verify your telegram account associated with the campaign</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-semibold mb-1">Update your newly created mainnet bitmask wallet username</h2>
          ...
          <Link
            href="/update"
            className="inline-block bg-accent text-black font-bold text-lg px-12 py-3 rounded-lg hover:opacity-90 transition-opacity mb-8"
          >
            START
          </Link>
        </div>
